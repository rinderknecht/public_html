...
\ncarc[linecolor=red,linestyle=dashed,arcangle=-35]{->}{s1}{s2}
\ncarc[linecolor=red,linestyle=dashed,arcangle=15]{->}{s2}{s3}
\ncarc[linecolor=red,linestyle=dashed,arcangle=0]{->}{s3}{s1s1}
\ncarc[linecolor=red,linestyle=dashed,arcangle=-35]{->}{s1s1}{s1s2}
\ncarc[linecolor=red,linestyle=dashed,arcangle=35]{->}{s1s2}{s3s1}
