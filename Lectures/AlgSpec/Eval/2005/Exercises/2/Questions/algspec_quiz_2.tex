...
\newcommand\oMem{\overline{\proc{Mem}}}
...
\begin{itemize}
   ...
   \proc{Default} : \type{t}\\
   The term \proc{Default} is a distinguished item, whose
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \rightarrow \type{bool}\)\\
    The call \(\proc{Mem}(a,e)\) is \proc{true} if \(e\) is an element
    of array \(a\) and \proc{false} otherwise.    
    ...
    the last modification (using \proc{Set}) at index \(n\). If \(a\)
