...
\title{Rattrapage (bis) de programmation fonctionnelle en Objective Caml}
...
\begin{itemize}
  ...
  \item toutes les étiquettes du sous-arbre de gauche (respectivement,
    de droite) sont inférieures (respectivement, supérieures) à
